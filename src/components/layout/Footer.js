        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 opacity-60">
              {/* Partner/Sponsor Logos - Currently commented out */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              ...
              >
                <XLogo size={20} className="text-gray-400 group-hover:text-white" />
              </a>
              <a
              ...
              >
                <FacebookLogo size={20} className="text-gray-400 group-hover:text-white" />
              </a>
              <a
              ...
              >
                <InstagramLogo size={20} className="text-gray-400 group-hover:text-white" />
              </a>
              <a
                href="https://linkedin.com/company/safesats"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors group"
                aria-label="Follow us on LinkedIn"
              >
                <LinkedinLogo size={20} className="text-gray-400 group-hover:text-white" />
              </a>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/cookie-policy" className="text-gray-400 hover:text-green-500 transition-colors">Cookie Policy</Link></li>
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">
              © SafeSats 2026. All rights reserved. | Empowering secure Bitcoin transactions worldwide.
            </p>
