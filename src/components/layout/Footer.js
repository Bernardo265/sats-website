          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              ...
              <a
                ...
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-black-500 transition-colors group"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gradient-to-r from-purple-600 to-pink-500 transition-colors group"
              >
